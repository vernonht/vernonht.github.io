  ...
  return (
    <section className="hero">
      <div className="container">
        <h1 data-aos="fade-up" data-aos-delay="700" >Hi, I'm <span className="highlight">Jian Hao</span></h1>
        <p className="subtitle" data-aos="fade-up" data-aos-delay="900">Software Engineer</p>
        ...
        <div className="cta-buttons">
          <a href="#experience" className="btn btn-primary" data-aos="fade-up" data-aos-delay="1300">View Experience</a>
